...
import com.eureka.product.VO.ProductInfoVO;
import com.eureka.product.VO.ProductVO;
...
import com.eureka.product.utils.ResultVOUtil;
...
//            e.printStackTrace();
//        }
        List<ProductInfoOutput> lst = productService.findList(productIdList);
        return lst ;
    }
